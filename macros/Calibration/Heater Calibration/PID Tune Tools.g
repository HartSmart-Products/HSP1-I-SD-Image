...
G90
G0 Z15 F300
G0 Y100 F{global.rapid_speed}					; Move the gantry to an accessible location
...
G0 Z15 F300
G0 X{move.axes[0].min} F{global.rapid_speed}	; Move the gantry to an accessible location
