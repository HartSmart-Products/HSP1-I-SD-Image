...
if sensors.probes[0].value[0]!=1000										; if sensor is value other than 1000, the probe is probably already picked up
	...
	; Deploy probe moves
	G0 X{global.dock_position_x+100} Y{global.dock_position_y} F{global.rapid_speed}; move to Preflight Position
	...
	G0 X{global.dock_position_x} Y{global.dock_position_y-70} F{global.rapid_speed}	; move to re-entry position
	M400																			; wait for moves to finish
