...
M308 S11 Y"bme-pressure" P"S3.1" A"Pressure[hPa]"
M308 S12 Y"bme-humidity" P"S3.2" A"Humidity[%]"
M308 S13 Y"mcu-temp" P"0.dummy" A"Primary 6XD MCU"					; defines sensor 13 as MCU temperature sensor
M308 S14 Y"mcu-temp" P"1.dummy" A"Secondary 6XD MCU"				; defines sensor 14 as MCU temperature sensor
...
M106 P4 C"Electronics Intake" H13:14 T20:45 L0.40 X1.0				; set fan 4 value. Thermostatic control is turned on
M950 F5 C"!0.out4+out4.tach" Q25000									; create fan 5 and set its frequency
M106 P5 C"Electronics Exhaust" H13:14 T20:45 L0.40 X1.0		        ; set fan 5 value. Thermostatic control is turned on
M950 F6 C"0.out2" Q500									            ; create fan 6 and set its frequency
M106 P6 C"Toolhead Cooling" H15:16 T50:60 L0.20 X0.4		        ; set fan 6 value. Thermostatic control is turned on
